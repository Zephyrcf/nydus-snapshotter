...
{{/*
Render snapshotter config.toml from the raw values entry with a small set of
targeted overrides kept for operational workflows.
*/}}
...
{{- if eq $current "" -}}
{{- fail "snapshotter.nydusdPath requires snapshotter.configuration to contain a nydusd_path entry" -}}
{{- end -}}
...
{{- if eq $current "" -}}
{{- fail "snapshotter.logLevel requires snapshotter.configuration to contain a log level entry" -}}
{{- end -}}
